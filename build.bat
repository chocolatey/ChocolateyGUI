...
IF "%APPVEYOR%"=="" (ECHO APPVEYOR: Not Defined) ELSE (ECHO APPVEYOR: %APPVEYOR%)
...
IF "%APPVEYOR_REPO_COMMIT_AUTHOR_EMAIL%"=="" (ECHO APPVEYOR_REPO_COMMIT_AUTHOR_EMAIL: Not Defined) ELSE (ECHO APPVEYOR_REPO_COMMIT_AUTHOR_EMAIL: %APPVEYOR_REPO_COMMIT_AUTHOR_EMAIL%)
...
IF "%APPVEYOR_REPO_COMMIT_MESSAGE%"=="" (ECHO APPVEYOR_REPO_COMMIT_MESSAGE: Not Defined) ELSE (ECHO APPVEYOR_REPO_COMMIT_MESSAGE: %APPVEYOR_REPO_COMMIT_MESSAGE%)
IF "%APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED%"=="" (ECHO APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED: Not Defined) ELSE (ECHO APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED: %APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED%)
